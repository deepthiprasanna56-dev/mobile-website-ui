...
export default function Hero3DDevice() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-80 sm:w-96 h-80 sm:h-96 bg-gradient-to-tr from-indigo-600/40 via-purple-600/35 to-pink-500/30 rounded-full blur-3xl pointer-events-none animate-pulse" />
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-72 sm:w-84 h-72 sm:h-84 border-2 border-indigo-500/30 rounded-full pointer-events-none animate-spin-slow" />
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-60 sm:w-72 h-60 sm:h-72 border border-purple-500/20 rounded-full pointer-events-none" />
      ...
      <motion.div
        ...
        className="relative mx-auto w-[275px] sm:w-[315px] h-[530px] sm:h-[590px] rounded-[50px] p-3.5 bg-gradient-to-b from-slate-800 via-slate-900 to-slate-950 border-2 border-indigo-500/60 shadow-[0_30px_70px_-15px_rgba(99,102,241,0.5)] group transition-all duration-300"
      >
        {/* Specular Lighting Glow Layer */}
        <motion.div
          style={{
            background: `radial-gradient(circle at ${glowX} ${glowY}, rgba(168, 85, 247, 0.45), transparent 60%)`,
          }}
          className="absolute inset-0 rounded-[50px] pointer-events-none z-30 opacity-80"
        />

        {/* Outer Frame Metallic Hardware Buttons */}
        <div className="absolute top-16 -left-1 w-1 h-10 bg-indigo-500/60 rounded-l-md" />
        <div className="absolute top-30 -left-1 w-1 h-14 bg-indigo-500/60 rounded-l-md" />
        <div className="absolute top-24 -right-1 w-1 h-16 bg-purple-500/60 rounded-r-md" />
        ...
        <div className="relative w-full h-full rounded-[42px] bg-slate-950 overflow-hidden border border-slate-800 flex flex-col justify-between p-4 shadow-inner">
          ...
          <div className="absolute top-3 left-1/2 -translate-x-1/2 w-28 h-5.5 bg-slate-900 rounded-full border border-slate-800/80 flex items-center justify-between px-3 z-40 shadow-md">
            ...
            <span className="w-8 h-1 rounded-full bg-indigo-500/60" />
          ...
          <div className="pt-7 space-y-3.5 relative z-20">
            {/* Top Status Header */}
            <div className="flex items-center justify-between bg-slate-900/90 p-2.5 rounded-2xl border border-indigo-500/30 backdrop-blur-md shadow-md">
              <div className="flex items-center gap-2">
                <div className="w-7.5 h-7.5 rounded-xl bg-gradient-to-tr from-indigo-500 via-purple-500 to-pink-500 p-0.5 shadow-md">
                ...
                <div>
                  ...
                  <p className="text-[9px] text-indigo-300 font-mono">React 19 &bull; OLED Active</p>
                </div>
              </div>
            ...
            <div className="relative rounded-2xl overflow-hidden bg-gradient-to-tr from-indigo-950/90 via-slate-900 to-purple-950/90 border border-indigo-500/40 p-3.5 text-left shadow-xl">
              <div className="flex items-center justify-between mb-2">
                <span className="text-[10px] font-mono uppercase tracking-wider text-indigo-300 bg-indigo-500/25 px-2.5 py-0.5 rounded-md border border-indigo-500/40 font-bold">
              ...
              <div className="mt-3.5 space-y-1">
                ...
                <div className="w-full h-1.5 rounded-full bg-slate-900 overflow-hidden border border-slate-800">
                  <div className="h-full w-[96%] bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 rounded-full animate-pulse" />
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-2">
              <div className="p-2.5 rounded-xl bg-slate-900/95 border border-indigo-500/30 flex items-center gap-2">
                <div className="w-6.5 h-6.5 rounded-lg bg-indigo-500/20 border border-indigo-500/30 flex items-center justify-center shrink-0">
                  <FiCpu className="w-3.5 h-3.5 text-indigo-400" />
                </div>
                <div>
                  <span className="text-[10px] font-bold text-white block">React 19</span>
                  <span className="text-[8px] text-indigo-300 font-mono">Supercharged</span>
                </div>
              </div>

              <div className="p-2.5 rounded-xl bg-slate-900/95 border border-purple-500/30 flex items-center gap-2">
                <div className="w-6.5 h-6.5 rounded-lg bg-purple-500/20 border border-purple-500/30 flex items-center justify-center shrink-0">
                  <FiLayers className="w-3.5 h-3.5 text-purple-400" />
                </div>
                <div>
                  <span className="text-[10px] font-bold text-white block">Tailwind v4</span>
                  <span className="text-[8px] text-purple-300 font-mono">Rich Styling</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="pt-2 pb-1 flex items-center justify-around bg-slate-900/95 rounded-2xl border border-slate-800 text-[10px] font-mono text-slate-300 z-20 shadow-md">
            <span className="text-indigo-400 font-bold">320px Ready</span>
            <span className="text-slate-600">&bull;</span>
            <span className="text-purple-400 font-bold">Zero Gaps</span>
            <span className="text-slate-600">&bull;</span>
            <span className="text-pink-400 font-bold">Hidden Scroll</span>
          </div>

          {/* Bottom Home Indicator Bar */}
          <div className="w-24 h-1 bg-indigo-500/60 rounded-full mx-auto mt-2 shrink-0 z-40" />
        </div>

        {/* Floating 3D Badge 1 */}
        <div
          style={{ transform: 'translateZ(55px)' }}
          className="absolute -top-3 -right-4 sm:-right-6 bg-slate-900/95 border border-indigo-500/50 p-3 rounded-2xl shadow-2xl backdrop-blur-md z-40 flex items-center gap-2.5"
        >
          <div className="w-8 h-8 rounded-xl bg-gradient-to-tr from-indigo-600 to-purple-600 flex items-center justify-center text-white font-bold text-xs shadow-lg shadow-indigo-600/40">
            3D
          </div>
          <div>
            <span className="text-xs font-extrabold text-white block">3D Interactive Tilt</span>
            <span className="text-[10px] text-indigo-300 font-mono">Touch & Cursor</span>
          </div>
        </div>
