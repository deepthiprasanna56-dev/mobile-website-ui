    ...
    <div className="pt-28 pb-16 min-h-screen bg-slate-950">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-12">
        <div className="flex items-center gap-2 text-xs font-mono text-slate-400 mb-4">
          ...
          <span>/</span>
          <span className="text-indigo-400 font-semibold">Community Testimonials</span>
        </div>
        ...
        >
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-amber-500/10 border border-amber-500/30 text-amber-300 text-xs font-mono uppercase mb-4">
            <FiStar className="w-4 h-4 text-amber-400 fill-amber-400" />
            <span>Dedicated Reviews Page View</span>
          </div>
          ...
          <p className="mt-4 text-base sm:text-lg text-slate-300 max-w-2xl mx-auto">
            Discover what frontend leads and mobile UX architects say about AURA3D's responsive performance and 3D scroll physics.
          </p>
        </motion.div>
      </div>
